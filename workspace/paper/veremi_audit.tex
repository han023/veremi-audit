...
\IEEEauthorblockA{Hannsoft\\ \url{https://www.hannsoft.org/}\\ abdullhannan0311@gmail.com\\ ORCID 0009-0000-7502-2755}}

\maketitle

\begin{abstract}
One untrained scalar exceeds AUC 0.99 on six of eight VeReMi archives.
That scalar is raw message count, never a claimed position.
...
The other 85, or 92.4\%, name none.
...
\begin{itemize}
  ...
  \item A single untrained scalar exceeds AUC 0.99 on six archives.
...
Three public artefacts form the primary substrate, verified by MD5 against Zenodo.
A fourth, VeReMi NextGen, is evaluated in Section~\ref{sec:generalise}.
...
\subsection{One scalar separates six of eight archives}
...
Message count exceeds AUC 0.99 on six of the eight.
Median interval reaches 1.000 on the four DoS archives.
...
Geometry, the physically motivated signal, varies widely.
...
Geometry, the physically motivated signal, is much weaker.
...
Benign identities never rotate in the four scenarios we measured.
The generator supports pseudonym change; these released runs do not exercise it.
Policy therefore stays unstudiable in the scenarios we obtained.
